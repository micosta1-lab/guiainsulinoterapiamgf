  ...
  if (step === 0) {
    ...
    const indicationItems = isIntensificar
      ? [
          ...
          { key: "insuficienciaRenalHepatica" as const, label: "Insuficiência renal ou hepática que condicione alteração das necessidades de insulina ou manutenção da terapêutica atual" },
